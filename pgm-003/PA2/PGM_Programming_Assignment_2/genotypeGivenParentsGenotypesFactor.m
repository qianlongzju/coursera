...
for i=1:length(genotypeFactor.val),
    ...
    alleleParentOne = genotypesToAlleles(assignment(2),:);
    alleleParentTwo = genotypesToAlleles(assignment(3),:);
    alleleChild = genotypesToAlleles(assignment(1),:);
    count = 0;
    if ((alleleParentOne(1) == alleleChild(1) && alleleParentTwo(1) == alleleChild(2))...
        || (alleleParentOne(1) == alleleChild(2) && alleleParentTwo(1) == alleleChild(1))),
        count += 1;
    end
    if ((alleleParentOne(1) == alleleChild(1) && alleleParentTwo(2) == alleleChild(2))...
        || (alleleParentOne(1) == alleleChild(2) && alleleParentTwo(2) == alleleChild(1))),
        count += 1;
    end
    if ((alleleParentOne(2) == alleleChild(1) && alleleParentTwo(1) == alleleChild(2))...
        || (alleleParentOne(2) == alleleChild(2) && alleleParentTwo(1) == alleleChild(1))),
        count += 1;
    end
    if ((alleleParentOne(2) == alleleChild(1) && alleleParentTwo(2) == alleleChild(2))...
        || (alleleParentOne(2) == alleleChild(2) && alleleParentTwo(2) == alleleChild(1))),
        count += 1;
    end
    genotypeFactor.val(i) = count / 4;
end
