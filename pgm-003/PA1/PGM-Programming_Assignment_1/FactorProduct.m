...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
assignmentA = IndexToAssignment(indxA, A.card);
assignmentB = IndexToAssignment(indxB, B.card);
valueA = GetValueOfAssignment(A, assignmentA);
valueB = GetValueOfAssignment(B, assignmentB);
C = SetValueOfAssignment(C, assignments, valueA .* valueB);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
