...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
values = GetValueOfAssignment(A, assignments);
for i=1:length(indxB),
    assignment = IndexToAssignment(indxB(i), B.card);
    value = GetValueOfAssignment(B, assignment);
    B = SetValueOfAssignment(B, assignment, value + values(i));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
