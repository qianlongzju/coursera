...
function M = ComputeApproxMarginalsBP(F,E)
    ...
    for i = 1:length(N),
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        [vars indexA] = unique([P.clusterList.var],"first"); % All the variables         
        ...
        for i=1:length(vars),                                                           
            j = FindPotentialWithVariable(P, vars(i));
            M(i) = FactorMarginalization(P.clusterList(j), ...               
                        setdiff(P.clusterList(j).var, vars(i)));             
